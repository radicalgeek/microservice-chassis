...
if (process.env.NODE_ENV === 'development') {
    ...
    AWSXRay.captureAsyncFunc = (name, fn) => fn(null);
}else{
...
process.on('uncaughtException', (error) => {
    AWSXRay.captureAsyncFunc('uncaughtException', (subsegment) => {
        if (subsegment) {
